...
import com.recomo.remotecontrol.preview.urdf.Pose
import com.recomo.remotecontrol.preview.urdf.Transform
import com.recomo.remotecontrol.preview.urdf.UrdfModel
import com.recomo.remotecontrol.preview.urdf.UrdfParser
...
object RobotKinematics {
    fun defaultConfig() = configForProfile(RobotProfile.RECOMO_PROTO1)
    ...
    fun configForProfile(profile: RobotProfile): RobotKinematicsConfig {
        return if (profile.isProto1Family()) {
            RobotKinematicsConfig(
                ...
                homeArmQDeg = listOf(135.0, 90.0, 0.0),  // elbow, pitch, yaw — ARM-H position
