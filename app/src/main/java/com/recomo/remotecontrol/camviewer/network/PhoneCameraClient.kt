...
class PhoneCameraClient(
    ...
    suspend fun setAfMode(phoneHost: String, mode: String) =
        sendCommand(phoneHost, CameraCommand.SetAfMode(mode))
    ...
    sealed class CameraCommand {
        ...
        @Serializable
        @SerialName("setAfMode")
        data class SetAfMode(val mode: String) : CameraCommand()
