...
enum class RobotProfile(
    ...
    RECOMO_PROTO1_CICDEVICE(
        displayName = "CICDevice (Orin 160)",
        robotName = "recomoProto1-cicdevice",
        unitId = "160-cic",
        productFamily = "recomoProto1",
        hardwareVariant = "cicdevice",
        useTztekOrin = false,
    ...
    companion object {
        fun selectableProfiles(): List<RobotProfile> {
            return listOf(NONE, RECOMO_PROTO1_DOGWOOD01, RECOMO_PROTO1_CEDAR01, RECOMO_PROTO1_ELM01, RECOMO_PROTO1_CICDEVICE, RECOMO_PROTO1_TEST02, VIRTUAL_SIM, CUSTOM)
        }
